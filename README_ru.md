...
**WikiStub-Seed — это готовый к многоязычному использованию JSON-фреймворк знаний для исследований с поддержкой ИИ, документирования, систем обучения и рабочих процессов LLM.** Включает тщательно подобранный набор данных `wikistub_seed.json` с 630 компактными заглушками знаний на немецком и английском языках, охватывающими 12 научных и культурных областей, подготовленные языковые слоты для ES/ZH/JA/RU, а также инструменты Python для валидации, экспорта и перевода.
...
- 630 заглушек знаний в `wikistub_seed.json` с контентом DE/EN и подготовленными языковыми слотами ES/ZH/JA/RU
...
| `web_publisher/` | Статический веб-/PWA-издатель (PWA, кэш офлайн, поиск, переключение DE/EN) |
...
- Схема-обёртка `wikistub-seed-data-v1` с подготовленными языковыми слотами DE/EN/ES/ZH/JA/RU
